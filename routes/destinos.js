...
router.get('/', securityLogger, apiRateLimiter, (req, res) => {
  const destinos = [
    ...
    },
    {
      ...
      imagem: '/imagens/portoseguro.png',
...
// Rota para compra direta do destino - exibe formulário de finalização
router.get('/:slug/comprar', (req, res) => {
  ...
  res.render('destinos/comprar', {
    ...
    description: `Finalize sua reserva para ${destino.nome}`,
    destino
  });
});
